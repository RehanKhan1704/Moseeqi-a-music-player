...
async function getSongs(folder) {
    ...
    // let a = await fetch(`http://192.168.1.107:3000/${folder}/`)
    // let a = await fetch(`http://127.0.0.1:5500/${folder}/`)
    // let a = await fetch(`http://192.168.1.105:3002/${folder}/`)
    // let a = await fetch(`http://192.168.1.105:3000/${folder}/`)
    // let a = await fetch(`http://192.168.1.104:3000/${folder}/`)
    // let a = await fetch(`http://127.0.0.1:5500/${folder}/`)
